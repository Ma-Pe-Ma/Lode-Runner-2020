...
//        		}
    ...
    public void setLastLevel(int lastLevel) {
        SharedPreferences sharedPref = activity.getSharedPreferences(activity.getString(R.string.configPreferences), Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPref.edit();
        boolean championsip = sharedPref.getBoolean("championship", false);

        if (championsip) {
            editor.putInt("champLastLevel", lastLevel);
        }
        else {
            editor.putInt("oriLastLevel", lastLevel);
        }
    ...
    native public void MessageFromNDK();
}
